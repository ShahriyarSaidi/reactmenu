...
export const translations = {
  az: {
    ...
    total: 'Cəmi',
    items: 'məhsul',
    categories: ['Başlanğıclar', 'Ana Yeməklər', 'Qril', 'İçkilər', 'Şirniyyatlar'],
    addBtn: 'Əlavə et',
  ...
  ru: {
    ...
    total: 'Итого',
    items: 'блюда',
    categories: ['Закуски', 'Основные блюда', 'Гриль', 'Напитки', 'Десерты'],
    addBtn: 'Добавить',
  ...
  en: {
    ...
    total: 'Total',
    items: 'items',
    categories: ['Starters', 'Main Course', 'Grill', 'Drinks', 'Desserts'],
    addBtn: 'Add',
